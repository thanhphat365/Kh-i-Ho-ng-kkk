    ...
    <div className="grid place-items-center min-h-screen font-sans bg-slate-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4">
      <div className="w-full max-w-md text-center flex flex-col items-center">
        <div className="mb-8 flex flex-col items-center w-full">
            {/* Container cho Logo: Căn giữa, khoảng cách đã được giảm (gap-4 -> gap-8 nếu cần rộng hơn, hiện tại gap-4 để gần nhau) */}
            <div className="flex w-full flex-row items-center justify-center gap-4"> 
                {/* NovaIcon: Kích thước lớn (w-40 = 160px) */}
                <NovaIcon className="w-40 h-40 text-primary-500 dark:text-primary-400" />
                
                {/* BrandmarkIcon: Chiều cao lớn (h-24 = 96px) để cân đối */}
                <BrandmarkIcon className="h-24 w-auto text-primary-500 dark:text-primary-400" />
            </div>
