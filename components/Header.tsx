  ...
  return (
    <header className="flex justify-between items-center p-2 md:p-3 shadow-md bg-white/80 dark:bg-gray-800/80 backdrop-blur-md sticky top-0 z-20 border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
        <div className="flex items-center gap-2 flex-1">
         {/* Giảm gap-2 xuống gap-1 để 2 logo gần nhau hơn */}
<a href="/" aria-label="Trang chủ NOVA" className="flex items-center gap-1 p-1">
    
    {/* Giảm w-16 (64px) xuống w-10 (40px) hoặc w-12 (48px) cho gọn */}
    <NovaIcon className="w-12 h-12 text-gray-800 dark:text-gray-200" />
    
    {/* Giảm h-12 xuống h-6 (24px) hoặc h-8 (32px) để cân đối với hình bên cạnh */}
    <BrandmarkIcon className="h-12 w-auto text-gray-800 dark:text-gray-200" />
